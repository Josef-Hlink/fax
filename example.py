...
def main():
    ...
    parser.add_argument("--exe", "-e", type=str)
    parser.add_argument("--iso", "-i", type=str)
    parser.add_argument("--rep", "-r", type=str)
    ...
    while True:
        ...
        if gs.menu_state in [melee.Menu.IN_GAME, melee.Menu.SUDDEN_DEATH]:
            ...
            contr1.tilt_analog(melee.enums.Button.BUTTON_MAIN, 1, 0.5)
            contr2.tilt_analog(melee.enums.Button.BUTTON_MAIN, 0, 0.5)
        else:  # we're in menus
